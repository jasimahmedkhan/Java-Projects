...
//    @PostMapping("upload-csv-file")
    ...
    @RequestMapping(value = "/status/{name}", method = RequestMethod.GET, produces = MediaType.TEXT_PLAIN_VALUE)
    @ResponseBody
    public String showStatus(@PathVariable(value = "name", required = false) String name){
